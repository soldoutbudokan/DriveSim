...
export const TIERS: Record<Tier, TierConfig> = {
  low: { pixelRatioCap: 1, shadowMap: 0, bloom: false, particleScale: 0.35, antialias: false },
  medium: { pixelRatioCap: 1.25, shadowMap: 1024, bloom: false, particleScale: 0.7, antialias: true },
  high: { pixelRatioCap: 1.75, shadowMap: 2048, bloom: true, particleScale: 1, antialias: true },
  ultra: { pixelRatioCap: 2, shadowMap: 4096, bloom: true, particleScale: 1, antialias: true },
};
